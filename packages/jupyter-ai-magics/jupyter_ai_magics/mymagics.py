...
#                 + "use %data_explore update to change its target"
#             )
...
#         with click.Context(line_magic_parser, info_name="%data_explore") as ctx:
...
#                 + "\n\n"
#                 + "If you were trying to run a command, run '%data_explore help' to see a list of commands.",
